...
public class EntryFileImporterFactory {
    ...
    private final Map<String, FileImporter<EntryRequest>> fileImporterMap;

    public EntryFileImporterFactory(Map<String, FileImporter<EntryRequest>> fileImporterMap) {
        this.fileImporterMap = fileImporterMap;
    }
